...
<body class="flex items-center justify-center p-4">
    <div class="w-full max-w-md login-container rounded-xl shadow-2xl overflow-hidden ">
        <!-- Header Section -->
        <div class="text-white p-6 text-center " style="background-color: rgba(154, 117, 23, 0.6);">
            <h1 class="text-2xl font-bold"> Eatwell   </h1>
            <p class="mt-1 text-blue-100"> eatwell to be well</p>
        </div>
        ...
        <div class="px-6 py-4 text-center border-t border-gray-200" style="background-color: rgba(249, 250, 251, 0.5);">
            <p class="text-sm text-gray-600">
                ...
                <a href="{{ route('register') }}" class="font-medium text-white hover:text-blue-800 underline decoration-2">Sign up</a>
            </p>
        </div>
    </div>
</body>
